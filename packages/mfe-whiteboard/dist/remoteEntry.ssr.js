  ...
  async function getExposesMap() {
    exposesMapPromise ??= import("virtual:mf-exposes-ssr:__mfe_internal__mfe_whiteboard__remoteEntry_js").then((mod) => mod.default ?? mod);
  ...
  async function init(shared = {}, initScope = []) {
    ...
    const initToken = { from: "mfe_whiteboard" };
