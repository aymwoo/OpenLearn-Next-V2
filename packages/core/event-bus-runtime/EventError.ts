...
export type EventErrorCode =
  'INVALID_EVENT' | 'INVALID_HANDLER' | 'HANDLER_FAILED' | 'HANDLER_TIMEOUT' | 'DISPATCH_CANCELLED' | 'BRIDGE_FAILED';
...
export class EventError extends Error {
  ...
  public constructor(message: string, code: EventErrorCode, eventType?: string, correlationId?: string) {
    super(message);
