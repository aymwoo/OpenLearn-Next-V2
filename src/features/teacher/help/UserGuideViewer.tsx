...
import { BookOpen, Users, LayoutTemplate, Sparkles, PenTool, PlayCircle, Globe } from 'lucide-react';
...
export const UserGuideViewer: React.FC<UserGuideViewerProps> = ({ copiedId, handleCopy }) => {
  return (
            ...
            <div>
              ...
              <div className="p-3 bg-indigo-50/50 rounded-xl border border-indigo-100 text-xs text-indigo-900 space-y-1.5 mt-3">
                ...
                <ul className="list-disc list-inside space-y-1 text-gray-600 text-xs">
                  ...
                  <li>
                    <code className="bg-white/80 px-1 rounded border border-indigo-150">student:write</code>
                    ：允许注册学生、修改学籍或修改设备锁定状态。
                  </li>
                  <li>
                    <code className="bg-white/80 px-1 rounded border border-indigo-150">schedule:write</code>
                    ：允许编排课程，或临时将某一日期的课程替换为星期几的常规课表。
                  </li>
                </ul>
              </div>
            </div>
  ...
  "lockedLessonId": "lesson-uuid-yyyy"
          ...
          <div className="bg-white rounded-2xl border border-gray-200 shadow-sm p-6 space-y-4 hover:shadow-md transition-all flex flex-col justify-between">
            <div>
              ...
              <div className="space-y-3 mt-3 text-xs text-gray-600 leading-relaxed">
                <p>
                  在系统"课程管理"中，教师可以使用内置大纲结构化的 Markdown
                ...
                <div className="p-3 bg-gray-50 rounded-xl border border-gray-150 space-y-1 text-xs font-sans">
                  ...
                  <p className="text-gray-500">
                    ...
                    <code className="font-mono text-rose-600 font-semibold bg-gray-100 px-0.5 rounded">#</code>)
                    与二级标题 (
                    <code className="font-mono text-rose-600 font-semibold bg-gray-100 px-0.5 rounded">##</code>)
                    作为教学<b>时间轴切片 (Timeline Segments)</b>。
                  </p>
                </div>
                ...
                <div className="p-3.5 bg-emerald-50/50 rounded-xl border border-emerald-100 space-y-2 text-xs text-emerald-800">
                  ...
                  <ol className="list-decimal list-inside space-y-1 text-gray-600 leading-relaxed">
                    <li>
                      当教师在教学控制台选中大纲某个段落时，前端会通过 WebSocket 通信管道发送一个{' '}
                      <code className="font-mono bg-white text-emerald-700 px-1 rounded border border-emerald-150">
                        sync_timeline
                      </code>{' '}
                      广播包。
                    </li>
                    <li>
                      学生终端捕获该消息包，解析出对应的锚点 DOM ID，并自动执行 DOM 的{' '}
                      <code className="font-mono bg-white text-emerald-700 px-1 rounded border border-emerald-150">
                    ...
                    <li>
                      在此模式下，学生终端的大脑侧边滚轮处于<b>阻尼锁定状态</b>
                      ，禁止自行向上游或下游浏览，以保证全体学生始终与教师保持完全一致的视野。
                    </li>
                  </ol>
                </div>
              </div>
          ...
          <div className="bg-white rounded-2xl border border-gray-200 shadow-sm p-6 space-y-4 hover:shadow-md transition-all flex flex-col justify-between">
            <div>
              ...
              <p className="text-xs text-gray-600 leading-relaxed mt-3">
                协作白板采用轻量级矢量序列化格式存储。每一笔涂鸦、矩形、圆形、文本或第三方卡片均被抽象为带有全局唯一 ID
  ...
  "data": "{\\"x\\":120,\\"y\\":80,\\"w\\":150,\\"h\\":60,\\"stroke\\":\\"#6366f1\\",\\"fill\\":\\"#e0e7ff\\"}"
              ...
              <div className="p-3 bg-amber-50/50 rounded-xl border border-amber-100 text-xs text-amber-900 space-y-2 mt-3">
                ...
                <p className="text-gray-600 leading-relaxed">
                  ...
                  <code className="bg-white text-amber-700 border border-amber-150 px-1 rounded font-mono">
                    whiteboard.draw
                  </code>{' '}
                  指令，动态在指定位置绘制结构化的几何内容或思维导图组件。
                </p>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="space-y-3 text-xs mt-3">
                <div className="flex gap-3 items-start">
                  <div className="h-5 w-5 font-mono font-bold bg-sky-100 border border-sky-200 text-sky-700 rounded-lg flex items-center justify-center shrink-0 mt-0.5">
                    1
                  </div>
                  <div>
