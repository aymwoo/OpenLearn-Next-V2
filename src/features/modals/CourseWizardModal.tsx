...
import { BookOpen, Sparkles, Activity, Plus, CheckCircle2, ChevronRight, Database, Loader2 } from 'lucide-react';
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-500 mt-0.5">
                    {lang === 'zh'
                      ? '遵循系统设计法，逐步构建您的学科专属教案与课堂时间轴流程。'
                      : 'Follow best practices to define curriculum content, timeline segments, and deploy.'}
                  </p>
                </div>
              </div>
              <button
                ...
                return (
                  <Fragment key={s.step}>
                    ...
                    >
                      ...
                      <span className="text-xs font-semibold hidden sm:inline">{lang === 'zh' ? s.zh : s.en}</span>
                    </div>
                    {idx < 3 && (
                      <div
                        className={`flex-1 h-0.5 max-w-[40px] md:max-w-none transition-all ${wizardStep > s.step ? 'bg-emerald-500' : 'bg-gray-200'}`}
                      />
                    )}
                  </Fragment>
                );
                    ...
                    <div className="md:col-span-2 space-y-4">
                      <div>
                        ...
                        <input
                          ...
                          placeholder={
                            lang === 'zh'
                              ? '例：西方哲学：康德的三大批判、Python编程入门、高中物理电路并联原理'
                              : 'e.g. Introduction to regressions, Western Philosophies, Lever Principles'
                          }
                      ...
                      <div>
                        ...
                        <textarea
                          ...
                          placeholder={
                            lang === 'zh'
                              ? '在此处编写您的授课背景、面向学段及最关键的 2-3 个核心教学总目标。'
                              : 'Write a short description stating learning outcomes and student prerequisite goals.'
                          }
                      ...
                      <div>
                        ...
                        >
                          ...
                          <option value="ComputerScience">
                            {lang === 'zh' ? '💻 计算机软件与人工智能' : '💻 Computer Science'}
                          </option>
                          <option value="Literature">
                            {lang === 'zh' ? '✍️ 语言文字与阅读理解' : '✍️ Literature & Writing'}
                          </option>
                          <option value="Physics">
                            {lang === 'zh' ? '⚡ 物理实验与自然探索' : '⚡ Physics & Science'}
                          </option>
                          <option value="History">
                            {lang === 'zh' ? '🏛️ 历史脉络与人地分析' : '🏛️ History & Humanities'}
                          </option>
                          <option value="Art">
                            {lang === 'zh' ? '🎨 交互设计与先锋创意艺术' : '🎨 Visual Arts & Design'}
                          </option>
                          <option value="Other">
                            {lang === 'zh' ? '🔮 交叉素养与综合学习' : '🔮 General & Other'}
                          </option>
                        </select>
                      </div>
                      ...
                      <div className="bg-slate-50 p-4 rounded-xl border border-gray-100 space-y-2 select-none text-left">
                        ...
                        <div className="text-xs text-gray-600 leading-relaxed font-sans mt-1">
                          {wizardCourseCategory === 'Mathematics' &&
                            (lang === 'zh'
                              ? '💡 数学：偏向理论推演。推荐 20分公式精讲 + 15分黑板实践互动，强化基础。'
                              : '💡 Math recommends: 20m Core Lecture + 15m Practice for theorem grounding.')}
                          {wizardCourseCategory === 'ComputerScience' &&
                            (lang === 'zh'
                              ? '💡 计算机：偏重编码体验。推荐 15分白板代码推演 + 20分终端实验与分享。'
                              : '💡 CS recommends: 15m Algorithms + 20m Interactive workshops on virtual boards.')}
                          {wizardCourseCategory === 'Literature' &&
                            (lang === 'zh'
                              ? '💡 语文文学：注重文本深度。推荐 10分范文研习 + 20分分组思辨，提升理解。'
                              : '💡 Lit recommends: 10m Reading Analysis + 20m Collaborative Discussions.')}
                          {wizardCourseCategory === 'Physics' &&
                            (lang === 'zh'
                              ? '💡 科学类：逻辑导向。推荐 10分虚拟视频实验 + 20分机理讲解 + 10分钟随堂答卷。'
                              : '💡 Science recommends: 10m virtual showcase + 20m principles + 10m evaluation.')}
                          {wizardCourseCategory === 'History' &&
                            (lang === 'zh'
                              ? '💡 历史人文：情景引入。推荐 15分人文画卷重塑 + 15分史实论驳辩论。'
                              : '💡 History recommends: 15m Context Mapping + 15m Interactive Debate panels.')}
                          {wizardCourseCategory === 'Art' &&
                            (lang === 'zh'
                              ? '💡 视觉创意：自由度高。推荐 10分美术鉴赏 + 25分白板手绘画布互动体验。'
                              : '💡 Art recommends: 10m Aesthetics inspiration + 25m real-time board drawing.')}
                          {wizardCourseCategory === 'Other' &&
                            (lang === 'zh'
                              ? '💡 其他科目：均分各小节时间，循序渐进，打造完整的教学循环闭环。'
                              : '💡 Generic: Divide evenly into sequential warm-up, core presentation and quiz.')}
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              {wizardStep === 2 && (
                <div className="space-y-5 animate-in fade-in duration-200 text-left font-sans">
                  ...
                  <div>
                    <label className="block text-xs font-bold text-gray-500 uppercase tracking-wider mb-2">
                      {lang === 'zh'
                        ? '💡 点击应用典型课堂框架模板 (Quick Apply)'
                        : '💡 Click to Auto-Apply Structure Presets'}
                    </label>
                      ...
                      {[
                        {
                          ...
                          desc:
                            lang === 'zh'
                              ? '由浅入深：先通过场景导入，后精讲，接着在白板配合大屏进行演练。'
                              : 'Perfect dynamic for most standard classes.',
                          segments: [
                            {
                              id: 'seg-preset-1',
                            ...
                            {
                              id: 'seg-preset-2',
                              title: 'Subject Core Lecture / 核心理论精讲',
                              type: 'lecture',
                              duration: '20m',
                              color: 'bg-indigo-50 text-indigo-700 border-indigo-200 hover:bg-indigo-100',
                              notes: 'Main content slide',
                            },
                            {
                              id: 'seg-preset-3',
                              title: 'Interactive Lab Work / 随堂协同演练',
                              type: 'practice',
                              duration: '15m',
                              color: 'bg-green-50 text-green-700 border-green-200 hover:bg-green-100',
                              notes: 'Exercises & questions',
                            },
                            {
                              id: 'seg-preset-4',
                              title: 'Wrap up / 课堂成果总结与答疑',
                              type: 'summary',
                              duration: '5m',
                              color: 'bg-purple-50 text-purple-700 border-purple-200 hover:bg-purple-100',
                              notes: 'Check answer notes',
                            },
                          ],
                        },
                        {
                          ...
                          desc:
                            lang === 'zh'
                              ? '协同探究：教师5分钟破冰，学生15分钟小组演练，15分钟对决汇报，10分钟定级。'
                              : 'Discussion and presentation heavy layout.',
                          segments: [
                            {
                              id: 'seg-preset-5',
                              title: 'Debate Scenario Brief / 讨论情境简述',
                              type: 'intro',
                              duration: '5m',
                              color: 'bg-amber-50 text-amber-700 border-amber-200 hover:bg-amber-100',
                              notes: 'Define debate metrics',
                            },
                            {
                              id: 'seg-preset-6',
                              title: 'Cooperative Ideation / 精英白板协作设计',
                              type: 'practice',
                              duration: '15m',
                              color: 'bg-green-50 text-green-700 border-green-200 hover:bg-green-100',
                              notes: 'Joint workspace analysis',
                            },
                            {
                              id: 'seg-preset-7',
                              title: 'Student Team Presentation / 各小组交互汇报',
                              type: 'lecture',
                              duration: '15m',
                              color: 'bg-indigo-50 text-indigo-700 border-indigo-200 hover:bg-indigo-100',
                              notes: 'Group screen sharing',
                            },
                            {
                              id: 'seg-preset-8',
                              title: 'Review & Grade Feedback / 教师深度对标点评',
                              type: 'summary',
                              duration: '10m',
                              color: 'bg-purple-50 text-purple-700 border-purple-200 hover:bg-purple-100',
                              notes: 'Score reviews',
                        ...
                        },
                        {
                          ...
                          desc:
                            lang === 'zh'
                              ? '应试/解惑突破：10分钟温习，15分钟重难盲点攻坚，15分钟专项题演习。'
                              : 'Perfect for exams and targeted training courses.',
                          segments: [
                            {
                              id: 'seg-preset-9',
                              title: 'Blind Spot Evaluation / 温史自学效果自测',
                              type: 'intro',
                              duration: '10m',
                              color: 'bg-blue-50 text-blue-700 border-blue-200 hover:bg-blue-100',
                              notes: 'Scan quiz',
                            ...
                            {
                              id: 'seg-preset-10',
                              title: 'Advanced Principle Explores / 重难考点极限拆解',
                              type: 'lecture',
                              duration: '15m',
                              color: 'bg-rose-50 text-rose-700 border-rose-200 hover:bg-rose-100',
                              notes: 'Analyse weak metrics',
                            },
                            {
                              id: 'seg-preset-11',
                              title: 'Mock Solving Battle / 核心精选题实操对抗',
                              type: 'practice',
                              duration: '15m',
                              color: 'bg-emerald-50 text-emerald-700 border-emerald-200 hover:bg-emerald-100',
                              notes: 'Sprint workout',
                            },
                            {
                              id: 'seg-preset-12',
                              title: 'Anchor Recap / 知识网架构网节点固化',
                              type: 'summary',
                              duration: '5m',
                              color: 'bg-purple-50 text-purple-700 border-purple-200 hover:bg-purple-100',
                              notes: 'Highlight checklist',
                            },
                          ],
                        },
                      ].map((preset) => (
                        <button
                          ...
                          onClick={() => {
                            ...
                            addToast(
                              ...
                              lang === 'zh'
                                ? `已将《${preset.title}》应用到您当前设计的课程中。`
                                : `Assigned "${preset.title}" timeslots.`,
                              'success',
                            );
                          }}
                  ...
                  <div>
                    <div className="flex items-center justify-between mb-2 select-none">
                      <label className="block text-xs font-bold text-gray-500 uppercase tracking-wider">
                        {lang === 'zh'
                          ? '📌 流程时间卡编辑 (拖拽或直接对表格字段赋值)'
                          : '📌 Custom Timeslot Table (Edit fields directly)'}
                      </label>
                      <button
                        type="button"
                        onClick={() => {
                          const newSeg = {
                            ...
                            title:
                              lang === 'zh'
                                ? `自理授课阶段 ${wizardCourseTimeline.length + 1}`
                                : `Interactive Step ${wizardCourseTimeline.length + 1}`,
                            type: 'practice',
                            duration: '10m',
                            ...
                            <button
                              ...
                              onClick={() => {
                                if (wizardCourseTimeline.length <= 1) {
                                  alert(
                                    lang === 'zh' ? '请保留至少一个核心环节！' : 'At least one segment must exist.',
                                  );
                                  return;
                                }
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 animate-in fade-in duration-200 font-sans text-left">
                  <div className="space-y-3 flex flex-col h-full min-h-[360px] text-left">
                      ...
                      <button
                        ...
                        onClick={() => {
                          ...
                          addToast(
                            ...
                            lang === 'zh'
                              ? '针对所选择的模型和属性已一键刷装教案模板框架。'
                              : 'Prepopulated Markdown structure.',
                            'success',
                          );
                        }}
                    ...
                    <textarea
                      ...
                      placeholder={
                        lang === 'zh'
                          ? '# 西方哲学三大经典原理\n\n在此输入您的具体内容讲解、白板图形绘制节点、以及课后实践任务大纲...'
                    ...
                    <div className="flex-grow overflow-y-auto bg-white border border-gray-150 rounded-lg p-4 text-xs font-sans text-gray-700 max-h-[380px] overflow-x-hidden text-left select-text">
                      {wizardCourseContent.trim() ? (
                        ...
                        <div className="flex flex-col items-center justify-center h-full text-gray-400 italic py-16">
                          ...
                          <span>
                            {lang === 'zh' ? '教案空无内容，等待输入或一键填充模板...' : 'Waiting for materials...'}
                          </span>
                        </div>
                      )}
                    </div>
                ...
                <div className="space-y-6 animate-in fade-in duration-200 text-center font-sans max-w-xl mx-auto py-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-400 mt-1">
                      {lang === 'zh'
                        ? '设计与时间轴逻辑全部检验合格。请在下方核验新课卡片，确认无误一键部署入 SQLite 内核数据库。'
                        : 'Curriculum parameters are ready to boot inside the Secure Host.'}
                    </p>
                  </div>
