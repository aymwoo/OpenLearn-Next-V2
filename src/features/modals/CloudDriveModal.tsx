...
export function CloudDrivePanel({
  vfsNodes, currentVfsParent, setCurrentVfsParent,
    ...
    <div className="flex-1 flex overflow-hidden min-h-0">
      ...
      <div className="w-64 border-r border-gray-100 flex flex-col bg-gray-50 shrink-0">
        ...
        <div className="flex-1 overflow-y-auto p-2">
          {currentVfsParent && (
            <button onClick={() => setCurrentVfsParent(null)} className="flex items-center gap-2 p-2 text-xs text-indigo-600 w-full hover:bg-gray-200 rounded mb-2 font-medium cursor-pointer">
        ...
        {cloudDrivePreviewNode ? (
          <div className="flex-1 flex flex-col h-full min-h-0">
            <div className="p-3 border-b border-gray-100 bg-gray-50 flex items-center gap-2 shrink-0">
              <button onClick={() => setCloudDrivePreviewNode(null)} className="text-gray-500 hover:text-gray-700 cursor-pointer"><X size={16} /></button>
    ...
    <div className="fixed inset-0 bg-gray-900/40 backdrop-blur-sm flex items-center justify-center p-6 z-50">
      <div className="bg-white border text-gray-900 border-gray-200 rounded-2xl shadow-2xl w-full max-w-5xl h-[85vh] flex flex-col overflow-hidden">
        <div className="p-4 border-b border-gray-100 flex items-center justify-between bg-gray-50/80 shrink-0">
          ...
          <button onClick={props.onClose} className="text-gray-400 hover:text-gray-600 font-bold p-1 hover:bg-gray-200 rounded transition-colors cursor-pointer">&times;</button>
        </div>
