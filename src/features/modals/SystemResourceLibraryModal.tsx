                  ...
                  <div className="flex-1 overflow-y-auto p-3 space-y-2">
                    ...
                    {!loadingLibraryResources && libraryResources.length === 0 && (
                      <div className="text-center py-12 text-xs text-slate-400 italic">
                        {lang === 'zh'
                          ? '暂无资源，支持拖入或上传文件。'
                          : 'No resources in library. Upload some above!'}
                      </div>
                    )}
                      ...
                      return (
                        ...
                        >
                          <div className="flex items-center gap-2.5 min-w-0">
                            <span className="text-base select-none">{resObj.type === 'folder' ? '📁' : '📄'}</span>
                            <div className="text-left min-w-0">
                              <div
                                className="text-xs font-semibold text-gray-700 truncate font-sans"
                                title={resObj.name}
                              >
                                {resObj.name}
                              </div>
                          ...
                          <button
                            onClick={async (e) => {
                              ...
                              if (
                                confirm(
                                  lang === 'zh'
                                    ? `确认删除资源 [${resObj.name}] 吗？`
                                    : `Delete resource [${resObj.name}]?`,
                                )
                              ) {
