        ...
        <div className="flex flex-col gap-3">
          ...
          <div>
            ...
            <textarea
              ...
              placeholder={
                lang === 'zh'
                  ? 'date,lesson_id,time_slot,status,notes\n2026-06-15,les-1,09:00 - 10:30,scheduled,首节授课\n2026-06-16,les-2,10:45 - 12:15,holiday,假期放假停课'
          ...
          {importMessage && (
            <div
              className={`p-2.5 rounded-lg text-xs border flex items-center gap-1.5 ${importMessage.type === 'error' ? 'bg-red-50 border-red-200 text-red-700' : 'bg-green-50 border-green-200 text-green-700'}`}
            >
              <AlertCircle size={14} />
