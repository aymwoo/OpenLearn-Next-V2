...
**Plans**: 4 plans
  ...
  - [x] 08-02-PLAN.md — 业务逻辑内置插件迁移 (management, builtin, server.ts cleanup) (completed 2026-06-19)
  - [x] 08-03-PLAN.md — AI 辅助插件迁移与旧系统删除 (ai-planner, ai-submit-injector, plugin-runtime deletion) (completed 2026-06-19)
  - [x] 08-04-PLAN.md — 第三方插件打包构建与 Worker 沙箱测试 (Quiz, Rollcall TS, build-plugins.mjs, E2E RPC test)
**UI hint**: no
...
| 8. 现有插件迁移 | 3/4 | In progress | 2026-06-19 |
